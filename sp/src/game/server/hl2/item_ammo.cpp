...
//	>> Colt Ammo
// ========================================================================
class CItem_ColtAmmo : public CItem
{
public:
	DECLARE_CLASS(CItem_ColtAmmo, CItem);
	...
	bool MyTouch(CBasePlayer *pPlayer)
	{
		if (ITEM_GiveAmmo(pPlayer, SIZE_AMMO_PISTOL, "Colt"))
		{
			if (g_pGameRules->ItemShouldRespawn(this) == GR_ITEM_RESPAWN_NO)
			{
				UTIL_Remove(this);
...
LINK_ENTITY_TO_CLASS(item_box_colt, CItem_BoxSRounds);
LINK_ENTITY_TO_CLASS(item_ammo_colt, CItem_BoxSRounds);

// ========================================================================
//	>> Glock
//================================================================
class CItem_GlockAmmo : public CItem
{
public:
	DECLARE_CLASS(CItem_GlockAmmo, CItem);
	...
	bool MyTouch(CBasePlayer *pPlayer)
	{
		if (ITEM_GiveAmmo(pPlayer, SIZE_AMMO_PISTOL, "Glock"))
		{
			if (g_pGameRules->ItemShouldRespawn(this) == GR_ITEM_RESPAWN_NO)
			{
				UTIL_Remove(this);
...
LINK_ENTITY_TO_CLASS(item_box_glock, CItem_BoxSRounds);
LINK_ENTITY_TO_CLASS(item_ammo_glock, CItem_BoxSRounds);

// ========================================================================
//	>> Makarov
//================================================================
class CItem_MakarovAmmo : public CItem
{
public:
	DECLARE_CLASS(CItem_MakarovAmmo, CItem);
	...
	bool MyTouch(CBasePlayer *pPlayer)
	{
		if (ITEM_GiveAmmo(pPlayer, SIZE_AMMO_PISTOL, "Makarov"))
		{
			if (g_pGameRules->ItemShouldRespawn(this) == GR_ITEM_RESPAWN_NO)
			{
				UTIL_Remove(this);
...
LINK_ENTITY_TO_CLASS(item_box_makarov, CItem_BoxSRounds);
LINK_ENTITY_TO_CLASS(item_ammo_makarov, CItem_BoxSRounds);
