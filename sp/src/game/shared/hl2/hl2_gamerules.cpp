...
//TLBS
ConVar	sk_plr_dmg_makarov("sk_plr_dmg_makarov", "0", FCVAR_REPLICATED);
ConVar	sk_npc_dmg_makarov("sk_npc_dmg_makarov", "0", FCVAR_REPLICATED);
ConVar	sk_max_makarov("sk_max_makarov", "0", FCVAR_REPLICATED);
...
ConVar	sk_npc_dmg_colt("sk_npc_dmg_colt", "0", FCVAR_REPLICATED);
ConVar	sk_max_colt("sk_max_colt", "0", FCVAR_REPLICATED);
...
CAmmoDef *GetAmmoDef()
{
	...
	if ( !bInitted )
	{
		...
		def.AddAmmoType("Makarov",          DMG_BULLET,                 TRACER_LINE_AND_WHIZ,   "sk_plr_dmg_makarov",       "sk_npc_dmg_makarov",       "sk_max_makarov",       BULLET_IMPULSE(200, 1225), 0);
		...
		def.AddAmmoType("Colt",             DMG_BULLET,                 TRACER_LINE_AND_WHIZ,   "sk_plr_dmg_colt",          "sk_npc_dmg_colt",          "sk_max_colt",          BULLET_IMPULSE(200, 1225), 0);
